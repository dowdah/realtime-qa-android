...
import com.dowdah.asknow.databinding.FragmentPendingQuestionsBinding;
...
public class PendingQuestionsFragment extends Fragment {
    ...
    private FragmentPendingQuestionsBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentPendingQuestionsBinding.inflate(inflater, container, false);
